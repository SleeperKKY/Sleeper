...
import org.androidtown.sleeper.endclasses.clStatManager;
        ...
        for (int i = 0; i <graphList.size(); i++) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    horizontalAxisSeekBar.setMax(statManager.getDataSizeList().get(v) - 1);
                    horizontalAxisSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                        ...
                        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                            ...
                            for(int i=0;i<currentGraph.getSeries().size();i++) {
                                ...
                                variableDataTextSeries1[i].setText(String.valueOf(series1.getValues(statManager.getXDataList().get(checkedRadioButton.getId())[progress],
                            ...
                            for(int i=0;i<currentGraph.getSecondScale().getSeries().size();i++) {
                                ...
                                variableDataTextSeries2[i].setText(String.valueOf(series2.getValues(statManager.getXDataList().get(checkedRadioButton.getId())[progress],
                                        statManager.getXDataList().get(checkedRadioButton.getId())[progress]).next().getY()));
